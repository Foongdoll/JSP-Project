...
public class ArtAuctionSearchCommand implements ArtInterface {
    ...
    int totRecCnt = dao.totAuctionSearchListRecCnt(searchContent,searchStr);
    ...
    ArrayList<ArtAuctionVO> vos = dao.getAuctionSearchWork(startIndexNo,pageSize,searchContent,searchStr);
    System.out.println("0 "+totRecCnt);
