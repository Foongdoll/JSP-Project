...
public class ArtAdminIpchalListCommand implements ArtAdminInterface {
    ...
    int totRecCnt = dao.totIpChalListRecCnt();
    ...
    ArrayList<ArtWorkIpchalVO> vos = dao.getIpchalAllList(startIndexNo,pageSize);
