...
public class ArtAdminVO {
	...
	public String toString() {
		return "ArtAdminVO [idx=" + idx + ", mid=" + mid + ", pwd=" + pwd + ", name=" + name + ", gender=" + gender
				+ ", email=" + email + ", nickName=" + nickName + ", tel=" + tel + ", birthday=" + birthday + ", address="
				+ address + ", hostIp=" + hostIp + ", point=" + point + ", startDate=" + startDate + ", lastDate=" + lastDate
				+ ", aggrement=" + aggrement + ", level=" + level + ", memDelete=" + memDelete + ", todayVisitCnt="
				+ todayVisitCnt + ", reportCnt=" + reportCnt + ", realPwd=" + realPwd + ", findId=" + findId + ", findPwd="
				+ findPwd + "]";
	}
